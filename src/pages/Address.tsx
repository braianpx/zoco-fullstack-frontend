...
export const Address = () => {
  ...
  const { addresses, isLoading, isAdmin, isError: getterError } = useAddressGetters(user);
  const {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-10 animate-in fade-in duration-700">
      <HeaderSection
        title="Direcciones"
        subtitle="Gestiona tus direcciones y ubicaciones"
        actions={
          <Button
      ...
      <AsyncBoundary
        ...
        errorMessage={isError ?? "No pudimos obtener la informacion de las direcciones."}
        emptyMessage="Todavia no hay direcciones registradas."
      />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 h-full">
          ...
          <div className="relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl z-50 overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <div className="animate-in fade-in slide-in-from-top-4 duration-500">
              <Card title={editing ? "Editar Direccion" : "Registrar Nueva Direccion"}>
                <AddressForm
            ...
            <div className="flex flex-col h-full">
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="flex gap-2 transition-opacity duration-300">
                  ...
                  <button
                    onClick={() => {
                      if (confirm("Eliminar?")) deleteAddressMutation.mutate(address.id);
                    }}
              ...
              <div className="space-y-2">
                <h4 className="text-2xl font-bold text-slate-900 group-hover:text-indigo-600 transition-colors">{address.street}</h4>
